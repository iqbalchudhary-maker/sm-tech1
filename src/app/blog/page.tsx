...
export default async function BlogMainPage() {
  // Database sync check: mapping ensures this looks for "Post" table in Neon
              ...
              <div className="p-8 flex-1 flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Abbas Bhatti</p>
                  </div>
